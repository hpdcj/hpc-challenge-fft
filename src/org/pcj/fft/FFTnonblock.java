...
@RegisterStorage(FFTnonblock.Shared.class)
public class FFTnonblock implements StartPoint {

    public final static boolean DO_PRINT = false;

    @Storage(FFTnonblock.class)
    enum Shared {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PCJ.start(FFTnonblock.class, new NodesDescription(nodesFileName));
    }
