...
@RegisterStorage(FFTblock.Shared.class)
public class FFTblock implements StartPoint {

    public final static boolean DO_PRINT = false;

    @Storage(FFTblock.class)
    enum Shared {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PCJ.start(FFTblock.class, new NodesDescription(nodesFileName));
    }
